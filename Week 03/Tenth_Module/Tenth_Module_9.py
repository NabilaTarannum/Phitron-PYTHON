...
class Window(QWidget):
    ...
    def ui(self):
        ...
        self.capture_btn.setFixedSize(60, 60)
        self.capture_btn.clicked.connect(self.record)
    ...
    def record(self):
        ...
        if self.record_flag == True:
            ...
            print("Starting to record process")
            self.get_time()
            self.out = cv2.VideoWriter(f"{self.dt}.mov", self.fourcc, 20.0, (640, 480))
...
if __name__ == "__main__":
    cap_icon_path = "Python/Week 3/Tenth_Module/assets/Camera.png"
    rec_icon_path = "Python/Week 3/Tenth_Module/assets/Video.png"
    stop_icon_path = "Python/Week 3/Tenth_Module/assets/Stop.png"
