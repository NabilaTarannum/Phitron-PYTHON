...
from Twentieth_Module_1_Airport import Airport


class AllAirports:
    def __init__(self) -> None:
        self.airports = None
        self.load_airport_data("./Week 06/Data/Airport.csv")
    ...
    def load_airport_data(self, file_path):
        ...
        with open("./Week 06/Data/Country_Currency.csv", "r") as file:
            lines = csv.reader(file)
            for line in lines:
    ...
    def get_distance_between_two_airports(self, lat1, lon1, lat2, lon2):
        ...
        a = sin(lat_diff / 2) * sin(lat_diff / 2) + cos(radians(lat1)) * cos(
            radians(lat2)
    ...
    def distance_between_two_airports(self, airport1_code, airport2_code):
        ...
        return self.get_distance_between_two_airports(
